    ...
    <form class="bd-search" method="get" action="{{ url('search') }}">
        ...
        <div class="input-group mb-3">
            ...
            <div class="input-group-append">
                <button class="btn btn-outline-secondary btn-danger" type="submit" id="button-addon2"
                    style="margin:0px;"><i class="fas fa-search"></i></button>
            </div>
        </div>
    </form>
</div>
...
<div class="fh5co-narrow-content">
    <div class="d-flex justify-content-between align-items-baseline animate-box" data-animate-effect="fadeInLeft">
        ...
        @if(@$_GET != '') <p class="text-right read-more-text"><a
                href="{{ url('search/sticker?q='.@$_GET['q'].'&country='.@$_GET['country'].'&category='.@$_GET['category']) }}">ดูทั้งหมด
                ></a></p> @endif
    </div>
...
<div class="fh5co-narrow-content">
    <div class="d-flex justify-content-between align-items-baseline animate-box" data-animate-effect="fadeInLeft">
        ...
        @if(@$_GET != '') <p class="text-right read-more-text"><a
                href="{{ url('search/emoji?q='.@$_GET['q'].'&country='.@$_GET['country'].'&category='.@$_GET['category']) }}">ดูทั้งหมด
                ></a></p> @endif
    </div>
    <div class="animate-box d-flex flex-wrap justify-content-around" data-animate-effect="fadeInLeft">
...
<div class="fh5co-narrow-content">
    <div class="d-flex justify-content-between align-items-baseline animate-box" data-animate-effect="fadeInLeft">
        ...
        @if(@$_GET != '') <p class="text-right read-more-text"><a
                href="{{ url('search/theme?q='.@$_GET['q'].'&country='.@$_GET['country'].'&category='.@$_GET['category']) }}">ดูทั้งหมด
                ></a></p> @endif
    </div>
    <div class="animate-box d-flex flex-wrap justify-content-around" data-animate-effect="fadeInLeft">
