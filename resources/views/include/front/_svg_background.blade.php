{{-- <svg class="icb ldlz" style="position:absolute;top:0;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1344 571.8">
    <style type="text/css">
        .ldlz {
            background: #adf linear-gradient(180deg, #adf 0%, #fff 60%, #fff 100%)
        }
    ...
    <image href="{{ asset('image/svg/rocket.svg') }}" width="50" height="50" x="1110" y="320" class="ld ld-fade-in"
        style="animation-delay:.615413s" />
    ...
    <image href="{{ asset('image/svg/rocket.svg') }}" width="70" height="70" x="1130" y="410" class="ld ld-fade-in"
        style="animation-delay:1.47676s" />
    <image href="{{ asset('image/svg/rocket.svg') }}" width="90" height="90" x="1040" y="350" class="ld ld-fade-in"
        style="animation-delay:1.09323s" />
